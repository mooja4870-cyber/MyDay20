...
echo "[4/6] Push"
git add   "$SMALI_PROJECT/AndroidManifest.xml"   "$SMALI_PROJECT/apktool.yml"   "$SMALI_PROJECT/assets/public/index.html"   "$SMALI_PROJECT/assets/public/assets/index-*.js"   "$SMALI_PROJECT/assets/capacitor.config.json"   "$SMALI_PROJECT/res/values/strings.xml"   PROJECT_STATUS.md
